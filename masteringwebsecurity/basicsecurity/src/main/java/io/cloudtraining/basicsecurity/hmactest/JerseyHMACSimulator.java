...
public class JerseyHMACSimulator {
	...
	public final static URI BASE_URI = UriBuilder.fromUri("http://localhost/").port(9999).build();

	protected static HttpServer startServer() throws IOException {
		final Map<String, String> initParams = new HashMap<String, String>();

		System.out.println("Starting JavaEE App Server - grizzly2...");
		initParams.put("com.sun.jersey.config.property.packages","io.cloudtraining.basicsecurity.hmactest");
	...
	public String makeHTTPCallUsingHMAC(
		...
		final String hmacRESTMicroserviceUrl = "http://localhost:9999/jerseyhmac/receive";
